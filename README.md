...
```html
<script src="https://ucarecdn.com/libs/widget-tab-effects/1.0.0-alpha.2/uploadcare.tab-effects.min.js" charset="utf-8"></script>
```

Or that one, bundled version without minification:

```html
<script src="https://ucarecdn.com/libs/widget-tab-effects/1.0.0-alpha.2/uploadcare.tab-effects.js" charset="utf-8"></script>
```
